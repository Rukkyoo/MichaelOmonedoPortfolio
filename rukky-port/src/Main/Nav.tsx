...
const Nav = () => {
  ...
  return (
    <div className="flex sticky top-0 flex-row justify-between bg-zinc-200 border-b-neutral-700 border-b-1">
      ...
      <div className="md:hidden flex justify-center items-center p-4">
        ...
        {menuOpen && (
          <div className="fixed top-0 left-0 w-full bg-zinc-200 border-b-neutral-700 border-b-1 p-4">
            <button
